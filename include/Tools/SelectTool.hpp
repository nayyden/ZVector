...
{
public:
	virtual void handleMousePressEvent(QMouseEvent *event, GroupManager *group);
	virtual void handleMouseReleaseEvent(QMouseEvent*, GroupManager*);
	virtual void handleMouseMoveEvent(QMouseEvent*, GroupManager*);
};
